...
public class Staff  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private String id;//编号(用于自己输入id，使用assigned)
     private Standard standard;//关联的收派标准
     private String name;//姓名
     private String telephone;
     private String haspda="0";//是否有移动设备，快递员的跟踪定位
     private String deltag="0";//删除标记位 ,未作废
     private String station;//单位
     private Set decidedzones = new HashSet(0);//所负责的定区
