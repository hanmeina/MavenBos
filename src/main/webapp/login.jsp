				...
				<s:form namespace="/"  action="login" id="loginform" name="loginform" method="post" cssClass="niceform">				
					...
					<div id="idInputLine" class="loginFormIpt showPlaceholder"
						...
						<s:textfield id="loginform:idInput"  name="username"
							class="loginFormTdIpt" maxlength="50" tabindex="1" title="请输入帐号"></s:textfield>
						<label for="idInput" class="placeholder" id="idPlaceholder">帐号：</label>
					</div>
					<div class="forgetPwdLine"></div>
					<div id="pwdInputLine" class="loginFormIpt showPlaceholder">
						<s:password id="loginform:pwdInput" class="loginFormTdIpt"
							name="password" value="" tabindex="2" title="请输入密码"></s:password>
